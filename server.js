...
app.get("/fetchcabinets", async (req, res) => {
...
app.get("/fetchbookshelves", async (req, res) => {

const query = `
SELECT *
FROM _imgproduct
WHERE img ILIKE '%Bookshelves%'
`;
...
app.get("/fetchsofas", async (req, res) => {
...
app.get("/fetchbeds", async (req, res) => {
